<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="EndRecipeSite.WebForm1" %>
            ...
            <table class="auto-style17">
                <tr>
                    <td class="auto-style19"><strong>
                        ...
                        <a href="MealDetail.aspx?YEMEKID=<%# Eval("YEMEKID") %>">     <asp:Label ID="Label3" runat="server" CssClass="auto-style16" Text='<%# Eval("YEMEKAD") %>'></asp:Label>
                            </a>
                ...
                <tr>
                    <td class="auto-style21"><strong>Eklenme Tarihi:</strong><asp:Label ID="Label6" runat="server" Text='<%# Eval("YEMEKTARIH") %>'></asp:Label>
